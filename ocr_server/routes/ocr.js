...
function capture_frame(video_name, video_time, x, y, w, h){
    return new Promise(function(resolve, reject){
        ...
        //@@서버에선 python3
        const result = spawn('python3', [__dirname + '/capture_module/converter.py', video_time, video_name, x, y, w, h]);
        try{
...
function ocr_imge(img_file_name){
    return new Promise(function(resolve, reject){
        ...
        //@@서버에선 python3
        const result = spawn('python3', [__dirname + '/ocr/ocr.py', img_file_name]);
        try{
            result.stdout.on('data', function(data){
                console.log(data.toString());
